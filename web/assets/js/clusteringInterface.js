...
mopsiMarkerClustering.prototype.gridBasedClustering = function () 
{
  ...
  if ( this.options.serverClient == "client" ) {
    ...
    params = {type: "gridbased", minX:p.minX1, maxX:p.maxX1,minY:p.minY,maxY:p.maxY, cellHeight:p.cellHeight, cellWidth:p.cellWidth, distMerge:p.minDist, representativeType:p.representativeType, iconWidth:p.iconWidth, iconHeight:p.iconHeight, markerStyle:p.markerStyle };
    ...
    params = {type: "gridbasedClientServer", minX:p.minX1, maxX:p.maxX1,minY:p.minY,maxY:p.maxY, cellHeight:p.cellHeight, cellWidth:p.cellWidth, distMerge:p.minDist, representativeType:p.representativeType, iconWidth:p.iconWidth, iconHeight:p.iconHeight, markerStyle:p.markerStyle};
...
mopsiMarkerClustering.prototype.getJsonInfo = function (group) 
{
  ...
  if ( clusterSize > 1 ) {
    ...
    } else { // "circle"  support variable size icons
...
mopsiMarkerClustering.prototype.distanceBasedClustering = function () 
{
  ...
  params = {type: "distancebased", minX:p.minX1, maxX:p.maxX1,minY:p.minY,maxY:p.maxY, distMerge:p.minDist, representativeType:p.representativeType};
...
mopsiMarkerClustering.prototype.pnnClustering = function () 
{
  ...
  params = {type: "pnn", minX:p.minX1, maxX:p.maxX1,minY:p.minY,maxY:p.maxY, distMerge:p.minDist, representativeType:p.representativeType};
